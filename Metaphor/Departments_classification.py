...
#         self.df = pd.read_csv('/kaggle/input/sih-2023/sample1.csv')
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('/Users/shashank/python/Metaphor/SIH-Department-Analysis')
        self.model = AutoModelForSequenceClassification.from_pretrained(
            "/Users/shashank/python/Metaphor/SIH-Department-Analysis", num_labels=len(departments),
